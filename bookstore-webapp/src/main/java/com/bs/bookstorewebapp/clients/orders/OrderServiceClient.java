...
public interface OrderServiceClient {
    ...
    OrderConfirmationDTO createOrder(@RequestHeader Map<String, String> headers, CreateOrderRequest orderRequest);

    @GetExchange("/orders/api/orders")
    List<OrderSummary> getOrders(@RequestHeader Map<String, String> headers);
